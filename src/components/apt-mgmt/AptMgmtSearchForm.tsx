  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 space-y-4">
      ...
      <button
        ...
        className="w-full bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-95 disabled:bg-gray-300 dark:disabled:bg-gray-600 text-white font-semibold py-2.5 px-4 rounded-lg transition-colors text-sm"
      >
        관리비 분석 시작
      </button>
    </form>
