...
import { AptHistoryResult, MonthlyStats, AreaStats, TransactionRow } from '@shared/lib/db/types';
import { MOCK_APT_HISTORY, MOCK_TRANSACTIONS } from '@shared/lib/db/mock-data';
