  ...
  return (
    <div className="mx-auto max-w-2xl p-4 pb-16">
      ...
      <nav className="text-xs text-gray-400 dark:text-gray-500 mt-4 mb-6 flex items-center gap-1.5 flex-wrap">
        ...
        <span>›</span>
        <span className="text-gray-600 dark:text-gray-300 font-medium">관리비 가이드</span>
      </nav>
      ...
      <article className="space-y-8">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-gray-100 dark:bg-gray-800">
                  <th className="text-left px-4 py-2 text-gray-700 dark:text-gray-300 font-medium">항목</th>
                  <th className="text-left px-4 py-2 text-gray-700 dark:text-gray-300 font-medium">구분</th>
                  <th className="text-left px-4 py-2 text-gray-700 dark:text-gray-300 font-medium">설명</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {[
                  ...
                  <tr key={item} className="text-gray-600 dark:text-gray-400">
                    <td className="px-4 py-2 font-medium text-gray-700 dark:text-gray-300">{item}</td>
                    <td className="px-4 py-2">
                      <span className={`text-xs px-1.5 py-0.5 rounded ${type === "공용" ? "bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300" : "bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300"}`}>
                        {type}
                      </span>
                    </td>
        ...
        <section className="space-y-3">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 text-sm space-y-2">
            <p className="font-medium text-gray-700 dark:text-gray-300">관리비에 영향을 주는 주요 요인</p>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">개인이 할 수 있는 절약 방법</h3>
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">입주자대표회의를 통한 절약</h3>
              <ul className="space-y-1.5 text-sm text-gray-600 dark:text-gray-400">
                {[
        ...
        <section className="space-y-3">
          ...
          <div className="bg-orange-50 dark:bg-orange-950 rounded-xl p-4 text-sm text-orange-800 dark:text-orange-200">
