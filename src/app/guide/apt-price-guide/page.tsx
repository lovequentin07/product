  ...
  return (
    <div className="mx-auto max-w-2xl p-4 pb-16">
      ...
      <nav className="text-xs text-gray-400 dark:text-gray-500 mt-4 mb-6 flex items-center gap-1.5 flex-wrap">
        ...
        <span>›</span>
        <span className="text-gray-600 dark:text-gray-300 font-medium">아파트 실거래가 가이드</span>
      </nav>
      ...
      <article className="prose prose-sm dark:prose-invert max-w-none space-y-8">
          ...
          <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            {[
              ...
              <li key={term} className="flex gap-2">
                <span className="font-medium text-gray-700 dark:text-gray-300 shrink-0">{term}:</span>
                <span>{desc}</span>
              </li>
            ))}
          </ul>
        ...
        <section className="space-y-3">
          ...
          <div className="bg-blue-50 dark:bg-blue-950 rounded-xl p-4 text-sm text-blue-800 dark:text-blue-200 space-y-2">
