  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      <div className="px-5 py-4 border-b border-gray-100">
        <h3 className="font-semibold text-gray-800">관리비 세부 비교</h3>
        <p className="text-xs text-gray-400 mt-0.5">세대당 월 평균 (원)</p>
      </div>
              ...
              return (
                <Fragment key={row.label}>
                  ...
                  >
                    ...
                    <td className="text-right px-2 sm:px-4 py-3 text-gray-500">
                  ...
                  {isOpen && row.children?.map((child) => (
                    <tr key={child.label} style={{ background: 'var(--ds-cream-muted)' }}>
                      ...
                      <td className="text-right px-2 sm:px-4 py-2 text-xs text-gray-400">
